        ...
        <>
            ...
            <AuthorCentreLayout>
                <section className="col-span-9">
                    ...
                    <h2 className="text-2xl font-bold mb-4">Welcome to your Author Dashboard</h2>
                    <p>
                        This is your Author Dashboard where you can manage your works, track your earnings, and connect
                        with your readers.
                    </p>
                    ...
                    <section className="mt-8">
                        ...
                        <div className="bg-gray-100 p-4 rounded">
                            <h4 className="text-lg font-bold mb-2">Title of the most recent work</h4>
