        ...
        <div className="py-10">
            ...
            >
                ...
                {Array.from({ length: 6 }).map((_, i) => (
                    <figure className="p-4 bg-gray-100 rounded shadow flex flex-col md:flex-row text-center" key={i}>
                        <div className="bg-gray-300 rounded-none w-full md:w-1/2 h-40 md:h-auto mb-4 md:mb-0">ss</div>
                        <div className="md:ml-4 text-center md:text-left space-y-2 flex-1">
                            ...
                            <blockquote>
                                <p className="text-lg font-medium">
                                    Short description of the book goes here. This is just a placeholder text.
                                </p>
                            </blockquote>
