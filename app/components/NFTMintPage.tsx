...
const NFTMintPage: React.FC = () => {
    ...
    return (
        <>
            <div>
                <h1 className="mb-4 text-2xl font-semibold text-center">Mint Your NFT</h1>
                <div className="mb-4">
                    <label className="block mb-2 text-sm font-medium text-gray-600">URI</label>
                    <input
                        type="text"
                ...
                <div className="mx-auto">
                    ...
                    <Button onClick={mintNFT} className="w-full text-white bg-red-600 rounded-md hover:bg-red-700">
                        Cancel
                    </Button>
                </div>
            </div>
